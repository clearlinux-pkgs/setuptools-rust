...
Source0  : https://files.pythonhosted.org/packages/3b/17/39804596680094ddabf2f44814c8919edb14da4f5db7b45e38915133f7fb/setuptools-rust-1.1.1.tar.gz
...
%prep
%setup -q -n setuptools-rust-1.1.1
cd %{_builddir}/setuptools-rust-1.1.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1638374406
...
cp %{_builddir}/setuptools-rust-1.1.1/LICENSE %{buildroot}/usr/share/package-licenses/setuptools-rust/b6d59af9754634678ceb503c91126c4248bf14c3
